 ...
 */
Navigation::Navigation(Block *sourcePoint) : source(sourcePoint) {
 ...
 * @return Navigation object.
 */
Navigation::Navigation(deque<Block *> *pathFromIds) {
    path = pathFromIds;
    stoppingPoints = new deque<Block *>();
}
 ...
 */
Block *Navigation::getNextLocation() {
 ...
 */
void Navigation::calculatePath(Block *block, Block *startBlock,
 ...
 */
void Navigation::addToPath(deque<Block *> *additionalPath) {
 ...
 */
bool Navigation::hasNextStoppingPoint() {
 ...
 */
void Navigation::addStoppingPoint(Block *block) {
 ...
 */
Block *Navigation::getNextStoppingPoint() {
    Block *block = stoppingPoints->front();
    stoppingPoints->pop_front();
    return block;
}

deque<int> Navigation::getOppositePath() {
